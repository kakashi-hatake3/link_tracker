...
class FakeClientSession:
    def __init__(self, fake_post=None, fake_get=None, fake_delete=None) -> None:
...
@pytest.mark.asyncio
async def test_register_chat_success(monkeypatch) -> None:
...
@pytest.mark.asyncio
async def test_register_chat_failure(monkeypatch) -> None:
    async def fake_post(url, **kwargs):
...
@pytest.mark.asyncio
async def test_add_link_success(monkeypatch) -> None:
    fake_link_response = {
        "id": 1,
...
@pytest.mark.asyncio
async def test_add_link_failure(monkeypatch) -> None:
    async def fake_post(url, **kwargs):
        return FakeResponse(400)
...
@pytest.mark.asyncio
async def test_remove_link_success(monkeypatch) -> None:
...
@pytest.mark.asyncio
async def test_remove_link_failure(monkeypatch) -> None:
    async def fake_delete(url, **kwargs):
...
@pytest.mark.asyncio
async def test_get_links_success(monkeypatch) -> None:
...
@pytest.mark.asyncio
async def test_get_links_failure(monkeypatch) -> None:
    async def fake_get(url, **kwargs):
        return FakeResponse(404)
